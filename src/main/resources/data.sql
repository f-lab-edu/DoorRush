...
INSERT INTO `ORDER` (ORDER_SEQ, USER_SEQ, ADDRESS, RESTAURANT_NAME, ORDER_STATUS, AMOUNT,
                     ORDER_TIME)
VALUES ('1', '25', '경기도 남양주 123-12', '칸지돈부리', 2, 17500, NOW()),
       ('2', '25', '서울특별시 강남구 55-8', '칸지돈부리', 2, 18500, NOW()),
       ('3', '25', '분당구 불정로 66', '칸지돈부리', 2, 19500, NOW()),
       ('4', '23', '분당구 불정로 66', '중식중 최고집', 2, 20500, NOW()),
       ('5', '23', '분당구 불정로 66', '중식중 최고집', 1, 33500, NOW());
